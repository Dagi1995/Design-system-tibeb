      ...
      {sections.map((section, sectionIndex) => {
        ...
        return (
          <div key={sectionIndex} className="mb-8">
            {section.title && (
              <div className="mb-4">
                <Label className="text-xl font-semibold">{section.title}</Label>
                  ...
                  {columnContents.map((content, contentIndex) => (
                    <div key={contentIndex} className="">
                      {content.type === 'Text' ? (
                        ...
                        <div className="bg-white  shadow-gray-400 min-h-[350px] shadow-sm rounded-lg p-4">
                          <Label className="font-semibold text-base mb-3 block">{content.name}</Label>
